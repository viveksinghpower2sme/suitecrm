...
class SugarWidgetSubPanelHistoryFilter extends SugarWidgetSubPanelTopButton {
    ...
    function display(&$widget_data) {
        ...
        $act_optioArray  = array('tasks','meetings','calls','notes','emails');
        $act_opt = '';
        ...
        $button = <<<EOHTML
                ...
                function ShowSubpanel{$subpanel_name}(){
                    var filter_module = document.getElementById('filter_module_his_dd').value;
                    ...
                    document.getElementById('filter_module_his_dd').value = filter_module;
                ...
                function clearFilter{$subpanel_name}(){
                    ...
                    <select id='filter_module_his_dd' onchange="ShowSubpanel{$subpanel_name}();">
