 ...
 * PLACE ANY CUSTOMIZATIONS IN abc12_Data
 */

require_once('include/SugarObjects/templates/company/Company.php');

class abc12_Data_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'abc12_Data';
	var $object_name = 'abc12_Data';
	var $table_name = 'abc12_data';
	var $importable = true;
