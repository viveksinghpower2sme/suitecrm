...
//user_role_list
								// hide user roles DD values in case of non admin user
								if(!$current_user->is_admin ){
									
									unset($GLOBALS['app_list_strings']['user_role_c_list']);
									$GLOBALS['app_list_strings']['user_role_c_list'][$this->bean->fetched_row['user_role_c']] = strtoupper($this->bean->fetched_row['user_role_c']);
								}
