...
class LeadsViewEdit extends ViewEdit
{
 ...
 function display(){
	...
	if(!empty($this->ev->focus->id))
	{
     ...
     <table id="tbl_phone"> <tr>
        <td><button onclick="javascript:add_phoneNumber()" id="add_email" type="button">
            <img alt="Array.LBL_ID_FF_ADD" src="themes/default/images/id-ff-add.png?v=jlL480K5YkTHsr6Wx8BATQ">
            </button></td><td>  Primary</td><td>&nbsp&nbsp &nbspOpted out</td><td>&nbsp &nbsp&nbspInvalid </td>
            </tr><tr><input type="hidden" name="phone_count" id="phone_count" value="0"/></td></tr></table><script>addRecords();</script>';
