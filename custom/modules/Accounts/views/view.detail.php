...
class AccountsViewDetail extends ViewDetail {
	...
	if(!empty($this->bean->id))
	{
		...
		//$query = "SELECT phone_phone.id,phone_phone.name,accounts_phone_phone_1_c.primary_contact,accounts_phone_phone_1_c.opted_out,accounts_phone_phone_1_c.invalid,accounts_phone_phone_1_c.sel_type FROM accounts_phone_phone_1_c JOIN phone_phone ON  accounts_phone_phone_1_c.accounts_phone_phone_1phone_phone_idb = phone_phone.id WHERE accounts_phone_phone_1_c.accounts_phone_phone_1accounts_ida = '$RecordID'";
		...
		{
			if($dataPhoneId['primary_contact'])
			{
