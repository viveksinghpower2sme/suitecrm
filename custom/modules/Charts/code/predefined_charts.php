...
$predefined_charts = array(
	...
	'Chart_pipeline_by_rfq_stage'=>
	array('type'=>'code','id'=>'Chart_pipeline_by_rfq_stage','label'=>$chartsStrings['LBL_CHART_PIPELINE_BY_RFQ_STAGE'],'chartType'=>'pie chart',),
	'Chart_pipeline_by_rfq_stage_created_by'=>
	array('type'=>'code','id'=>'Chart_pipeline_by_rfq_stage_created_by','label'=>$chartsStrings['LBL_CHART_PIPELINE_BY_RFQ_STAGE_CREATED_BY'],'chartType'=>'pie chart',),
);