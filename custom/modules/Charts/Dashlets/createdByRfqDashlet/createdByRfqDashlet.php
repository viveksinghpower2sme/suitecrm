...
class createdByRfqDashlet extends DashletGenericChart 
{
    ...
    public function display() 
    {
        ...
        if ( count($this->pbls_ids) > 0 )
            $sugarChart->url_params['created_by'] = array_values($this->pbls_ids);	
    ...
    protected function constructQuery()
    {
		...
		if ( count($this->pbls_ids) > 0 )
            $query .= "AND aos_quotes.created_by IN ('".implode("','",$this->pbls_ids)."') ";
