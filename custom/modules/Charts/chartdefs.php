...
$chartDefs = array(
	...
	'outcome_by_lead'=>
	array(	'type' => 'code',
			'id' => 'Chart_outcome_by_lead',
			'label' => $chartsStrings['LBL_CHART_OUTCOME_BY_LEAD'],
			'chartUnits' => $chartsStrings['LBL_OPP_SIZE'] . ' $1' . $chartsStrings['LBL_OPP_THOUSANDS'],
			'chartType' => 'stacked group by chart',
			'groupBy' => array( 'm', 'lead_source', ),
			'base_url'=> 
				array( 	'module' => 'Leads',
						'action' => 'index',
						'query' => 'true',
			...
			'url_params' => array( 'lead_source', 'date_modified' ),								
		 ),
	'pending_lead'=>
        array(  'type' => 'code',
                        'id' => 'Chart_pending_lead',
                        'label' => $chartsStrings['LBL_CHART_PENDING_LEAD'],
                        'chartUnits' => $chartsStrings['LBL_OPP_SIZE'] . ' $1' . $chartsStrings['LBL_OPP_THOUSANDS'],
                        'chartType' => 'stacked group by chart',
                        'groupBy' => array( 'm', 'lead_source', ),
                        'base_url'=> 
	...
	'pipeline_by_rfq_stage'=>
		array(	'type' => 'code',
				'id' => 'Chart_pipeline_by_rfq_stage',
				'label' => $chartsStrings['LBL_CHART_PIPELINE_BY_RFQ_STAGE'],
				'chartUnits' => $chartsStrings['LBL_RFQ_SIZE'] . ' $1' . $chartsStrings['LBL_RFQ_THOUSANDS'],
				'chartType' => 'pie chart',
				'groupBy' => array( 'rfq_state_c','user_name'),
				'base_url'=> 
					array( 	'module' => 'AOS_Quotes',
							'action' => 'index',
							'query' => 'true',
							'searchFormTab' => 'advanced_search',
						 ),
				'url_params' => array('assigned_user_id','rfq_state_c'),
			 ),
	'pipeline_by_rfq_stage_created_by'=>
	array(	'type' => 'code',
			'id' => 'Chart_pipeline_by_rfq_stage_created_by',
			'label' => $chartsStrings['LBL_CHART_PIPELINE_BY_RFQ_STAGE_CREATED_BY'],
			'chartUnits' => $chartsStrings['LBL_RFQ_SIZE'] . ' $1' . $chartsStrings['LBL_RFQ_THOUSANDS'],
			'chartType' => 'pie chart',
			'groupBy' => array( 'rfq_state_c','user_name'),
			'base_url'=> 
			...
			'url_params' => array('created_by','rfq_state_c'),
		 ),
