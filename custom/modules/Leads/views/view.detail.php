...
global $db;
	...
	if(!empty($this->bean->id))
	{
		...
		$query = "SELECT phone_phone.id,phone_phone.name,phone_phone_leads_1_c.primary_contact,phone_phone_leads_1_c.opted_out,phone_phone_leads_1_c.invalid,phone_phone_leads_1_c.sel_type FROM phone_phone_leads_1_c JOIN phone_phone ON  phone_phone_leads_1_c.phone_phone_leads_1phone_phone_ida = phone_phone.id WHERE phone_phone_leads_1_c.phone_phone_leads_1leads_idb = '$RecordID'";
