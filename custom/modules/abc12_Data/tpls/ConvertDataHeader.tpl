...
/**
  ...
  *  addDropdownElements fills data_conv_ac_op_sel with all required modules except Contacts 
...
function addRemoveDropdownElement(module) {
    var accountText = document.getElementById('lead_name');
