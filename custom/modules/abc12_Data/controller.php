...
class abc12_DataController extends SugarController{
	function abc12_DataController(){
	...
	protected function callLegacyCode(){
    	...
    	if(strtolower($this->do_action) == 'convertdata'){
            
        	if(file_exists('modules/abc12_Data/ConvertData.php') && !file_exists('custom/modules/abc12_Data/metadata/convertdefs.php')){
