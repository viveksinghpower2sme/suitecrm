...
//print_r($custom_join); die;
        ...
        $query = "SELECT $table.*,GROUP_CONCAT(phone_phone.name SEPARATOR ', ') as phone_office,
      ...
      //  Join phone no. too.
         $query .=  " LEFT JOIN abc12_data_phone_phone_1_c on $table.id = abc12_data_phone_phone_1_c.abc12_data_phone_phone_1abc12_data_ida";
        $query .=  " LEFT JOIN phone_phone on abc12_data_phone_phone_1_c.abc12_data_phone_phone_1phone_phone_idb = phone_phone.id ";
