 ...
 *
 */
require_once('service/v5/SugarWebServiceImplv5.php');
require_once('service/v5_1/SugarWebServiceUtilv5_1.php');

class SugarWebServiceImplv5_1 extends SugarWebServiceImplv5
{
    ...
    {
        self::$helperObject = new SugarWebServiceUtilv5_1();
    }
